...
set output 'no_of_flows_vs_mean_throughput_tcp_mptcp_simult.png'
#set xdata time
#set timefmt "%S"
...
set format y "%s"
set title "No of Sub Flows vs Average Throughput. MPTCP and TCP Simultaneous"
...
plot "mptcp_tcp_simult_with_increasing_sub_flows.txt" using 1:2 with line title "SUM",\
"mptcp_tcp_simult_with_increasing_sub_flows.txt" using 1:3 with line title "ETHR",\
"mptcp_tcp_simult_with_increasing_sub_flows.txt" using 1:4 with line title "WIFI",\
"mptcp_tcp_simult_with_increasing_sub_flows.txt" using 1:5 with line title "TCP"
