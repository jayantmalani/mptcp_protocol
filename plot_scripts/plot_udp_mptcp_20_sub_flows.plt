set terminal png
set output 'MPTCP_UDP_20_SubFlows_Throughput_vs_Time.png'
#set xdata time
#set timefmt "%S"
set xlabel "time"
...
set format y "%s"
set title "MPTCP/UDP 20 SubFlows Throughput vs Time"
set key reverse Left outside
set grid
f(x) = mean_1
fit f(x) 'mptcp_udp_on_eth_mptcp_w_20Subflows.txt' via mean_1
f(x) = mean_2
fit f(x) 'mptcp_udp_on_eth_udp_w_20Subflows.txt' via mean_2
