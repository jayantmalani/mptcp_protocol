...
set format y "%s"
set title "MPTCP TCP Flows Throughput vs Time"
...
label1 = gprintf("5 MPTCP Flow= %g", mean_1)
label2 = gprintf("5 TCP Flow= %g", mean_2)
label3 = gprintf("5 MPTCP 10 Flow= %g", mean_3)
LABEL=label1."\n".label2."\n".label3
...
set label 10 at 650,2000 LABEL front center
