set terminal png
set output 'MPTCP_TCP_brk_wifi_Throughput_vs_Time.png'
#set xdata time
#set timefmt "%S"
set xlabel "time"
...
set format y "%s"
set title "MPTCP/TCP break Wifi Throughput vs Time"
...
plot "mptcp_on_w_e_wifi_olia_brk.txt" using 2 with line title "Wifi", \
"mptcp_on_w_e_wifi_olia_brk.txt" using 1 with line title "Ethr" 
