set terminal png
set output 'MPTCP_Throughput_vs_Time_Balia.png'
#set xdata time
#set timefmt "%S"
set xlabel "time"
...
plot "mptcp_on_w_e_wifi_balia.txt" with line title "WIFI", \
"mptcp_on_w_e_ethr_balia.txt" with line title "ETHR", \
 "mptcp_on_w_e_sum_balia.txt" with line title "WIFI+ETHR" 
